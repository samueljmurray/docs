...
If you're on Rails this is installed automatically. There is nothing you manual you need to do. For everything else, please follow the [Rack installation instructions](/languages/ruby/integrations/rack). User context is captured through a simple middleware.
