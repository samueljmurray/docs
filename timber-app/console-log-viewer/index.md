...
1. [**Faceting your logs**](faceting-your-logs)
2. [**Inspect HTTP requests**](inspect-http-requests)
3. [**Keyboard shortcuts**](keyboard-shortcuts)
4. [**Link to a log**](link-to-a-log)
5. [**Seek to a time**](seek-to-a-time)
6. [**Searching**](searching)
7. [**Tail a user**](tail-a-user)
8. [**Trace HTTP requests**](trace-http-requests)
9. [**View a log's metadata & context**](view-metadata-and-context)
