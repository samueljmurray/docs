...
1. [Search it](/docs/app/console/searching) with queries like: `http_request.service_name:stripe`
...
4. ...read more in our [docs](/docs/languages/elixir/usage/tracking-background-jobs-and-tasks)
